-- ============================================================================
-- FIX v3: onboard_member_manually RPC — definitive column alignment
-- 
-- PAYMENTS table — real columns only:
--   ✅ gym_id, user_id, member_id, amount, status, plan_id
--   ✅ description, paid_at, payment_date, created_at, updated_at
--   ✅ approved_by, approved_at
--   ❌ currency, plan_name, payment_method  (DO NOT EXIST)
--
-- MEMBERSHIP table — real columns only:
--   ✅ user_id, gym_id, access_mode (REQUIRED), membership_status
--   ✅ approved, approved_at, paid_at, calibration_required
--   ✅ calibration_completed, unique_member_id
--   ❌ approved_by, plan_id, renewal_date  (DO NOT EXIST)
-- ============================================================================
...
BEGIN
    ...
    --    access_mode is REQUIRED (NOT NULL). approved_by / plan_id / renewal_date do NOT exist.
