-- =====================================================
-- PERFORMANCE TURBO: INDEXES & UNIFIED RPC (V2)
-- =====================================================

-- 1. CRITICAL INDEX INJECTION
CREATE INDEX IF NOT EXISTS idx_xp_transactions_user_id ON public.xp_transactions(user_id);
CREATE INDEX IF NOT EXISTS idx_workout_sessions_user_id ON public.workout_sessions(user_id);
CREATE INDEX IF NOT EXISTS idx_daily_nutrition_logs_user_id ON public.daily_nutrition_logs(user_id);
CREATE INDEX IF NOT EXISTS idx_daily_nutrition_logs_logged_at ON public.daily_nutrition_logs(logged_at);
CREATE INDEX IF NOT EXISTS idx_room_members_user_id ON public.room_members(user_id);
CREATE INDEX IF NOT EXISTS idx_user_calendar_selections_user_id ON public.user_calendar_selections(user_id);
CREATE INDEX IF NOT EXISTS idx_user_fitness_goals_user_id_active ON public.user_fitness_goals(user_id) WHERE is_active = true;

-- 2. THE TURBO SYNC RPC
